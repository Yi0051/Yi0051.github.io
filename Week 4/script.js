var kitty = {
    ...
    threats: null,
    meow: function meow(){ // a function containes as a key value pair of an object is called a method
        return "meow";
...
kitty.two = 'two'; // object are changeable and mustable (you can add to them after they are created)
console.log(kitty);
...
//null gets coerced to 0 when changing to typ number!!
